...
st.write("""
Welcome to **HerWellAI**! This app provides personalized health advice based on your inputs. Here's how to use it:
1. **Adjust the sliders** to match your health profile.
2. **Describe your health concerns** in the text box.
3. Click **Submit** to receive personalized advice from our AI-powered health assistant.
